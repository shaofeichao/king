package com.sfc.sso_server.pub.conf;

import com.sfc.sso_server.SsoServerApplication;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage(SsoServerApplication.class.getPackage().getName()))
