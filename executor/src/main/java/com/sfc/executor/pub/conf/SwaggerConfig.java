package com.sfc.executor.pub.conf;

import com.sfc.executor.ExecutorApplication;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage(ExecutorApplication.class.getPackage().getName()))
